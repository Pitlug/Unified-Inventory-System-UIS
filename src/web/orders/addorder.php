        ...
        <form id="orderForm">
            ...
            <div class="form-group">
                ...
                <input id="orderName" type="text" placeholder="Enter Order Name" required
                    value="'.htmlspecialchars($orderNameVal).'" />
            </div>
            ...
            <div class="form-group">
                ...
                <table border="1" cellpadding="8" cellspacing="0"
                    ...
                    <tbody id="itemsTable">
                        ...
                        <tr class=\"item-row\" data-item-idx=\"$idx\">
                            <td><input type=\"text\" class=\"item-name\" value=\"$name\" style=\"width:100%;\" /></td>
                            <td><input type=\"number\" class=\"item-qty\" value=\"$qty\" min=\"1\"
                                    style=\"width:100%;\" /></td>
                            <td><input type=\"number\" class=\"item-price\" value=\"$price\" min=\"0\" step=\"0.01\"
                                    style=\"width:100%;\" /></td>
                            <td><button type=\"button\" class=\"item-remove-btn\"
                                    style=\"cursor:pointer;color:red;\">Remove</button></td>
                        </tr>
                        ";
                        }, $orderItemsArray, range(0, count($orderItemsArray) - 1))) : '').'
                    </tbody>
                </table>
                <button type="button" id="addItemBtn" class="btn btn-outline-secondary" style="margin-right: 5px;">+ Add
                    Item</button>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="notes" rows="3"
                    placeholder="Enter any notes about the order here">'.htmlspecialchars($notesVal).'</textarea>
            </div>
